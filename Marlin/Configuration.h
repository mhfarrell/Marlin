...
#define STRING_CONFIG_H_AUTHOR "mhfarrell, 01/06/2022" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Martin The Printer"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  24.7251
    #define DEFAULT_Ki   2.3064
    #define DEFAULT_Kd 66.2632
  #endif
#else
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 205.0617
  #define DEFAULT_bedKi 40.0511
  #define DEFAULT_bedKd 699.9442
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 389.5200 }
